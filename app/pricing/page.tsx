          ...
          <TooltipProvider>
            {pricingItems.map(({ plan, tagline, quota, features }) => {
              ...
              return (
                ...
                >
                  {plan === "Pro" && (
                    <div className="absolute -top-5 left-0 right-0 mx-auto w-32 rounded-full bg-gradient-to-r from-lime-600 to-green-600 px-3 py-2 text-sm font-medium text-white">
                      Upgrade now
                    </div>
                  )}
                  ...
                  <div className="flex h-20 items-center justify-center border-b border-t border-gray-200 dark:border-gray-600">
                  ...
                  <div className="p-5">
                    {plan === "Free" ? (
                      ...
                      >
                        {user ? "You are Free user" : "Sign up"}
